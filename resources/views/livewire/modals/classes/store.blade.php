    ...
    <div
        ...
        <div
            ...
            <div class="flex justify-between items-center py-3 px-4 border-b border-gray-200">
                <h3 id="classes-add-modal-label" class="font-bold text-gray-800">
            ...
            <div class="p-4">
                ...
                <form action="" class="space-y-4 mb-4 relative h-fit" wire:submit="store">
                    ...
                    @if ($warningTeacher)
                        <div class="bg-yellow-50 border-t-2 border-yellow-500 rounded-lg p-4"
                    ...
                    <div class="{{ !$classes ? 'hidden' : 'block' }} space-y-4">
                        <div class="relative z-[300] max-h-20 overflow-x">
                            <select wire:model.live="majors_id"
                                class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none border">
                        ...
                        <div class="">
                            <div class="relative">
                                <input wire:model='class' type="number" id="hs-inline-leading-pricing-select-label"
                                    name="inline-add-on"
                                    class="py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none"
