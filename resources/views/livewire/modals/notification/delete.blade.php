<div id="notification-delete-modal" wire:ignore.self
    class="hs-overlay hidden size-full fixed top-0 start-0 z-[90] overflow-x-hidden overflow-y-auto pointer-events-none"
    role="dialog" tabindex="-1" aria-labelledby="notification-delete-modal-label">
    <div
        ...
        <div
            ...
            <div class="flex justify-between items-center py-3 px-4">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#notification-delete-modal">
            ...
            <div class="p-4 overflow-y-auto space-y-8">
                ...
                <div class="space-y-2 text-center px-8">
                    ...
                    <p class="text-sm">Apakah anda yakin ingin menghapus notifikasi?</p>
                </div>
                ...
                <div class="flex justify-center items-center gap-x-2 mb-8">
                    <button type="button"
                        ...
                        data-hs-overlay="#notification-delete-modal">
                        Close
                    </button>
