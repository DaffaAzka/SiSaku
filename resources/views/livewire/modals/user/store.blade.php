                            ...
                            @if (!$student)
                                <div class="relative">
                                    <input wire:model='password' type="password"
                                        id="hs-inline-leading-pricing-select-label" name="password"
                                        class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none"
                                ...
                                @if ($roleOption == 1)
                                    <div class="relative">
                                        <input wire:model='nisn' type="text"
                                            id="hs-inline-leading-pricing-select-label" name="nisn"
                                            class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none"
                                ...
                                @if ($roleOption == 2)
                                    <div class="relative">
                                        <input wire:model='nip' type="text"
                                            id="hs-inline-leading-pricing-select-label" name="nip"
                                            class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none"
                        ...
                        <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-gray-200">
                            ...
                            <div class="{{ $student ? '' : 'hidden' }}">
                                <button type="button" aria-expanded="false" aria-controls="user-password-modal"
                                    ...
                                    wire:click="$dispatch('passwordSelected', { studentId: '{{ $student->id ?? 0 }}' })"
