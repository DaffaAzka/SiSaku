        ...
        <div
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <form action="" class="space-y-4 mb-4 relative" wire:submit="storeTransaction">
                        ...
                        <div class="">
                            <div class="relative">
                                <input wire:model='amount' type="text" id="hs-inline-leading-pricing-select-label"
                                    name="inline-add-on"
                                    class="py-2.5 sm:py-3 px-4 ps-10 pe-20 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none"
                                    placeholder="0.00">
                    ...
                    <div
                        class="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-gray-200">
                        <button type="button"
