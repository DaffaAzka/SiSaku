    ...
    <div
        ...
        <div
            ...
            <div class="flex justify-between items-center py-3 px-4 border-b border-gray-200 dark:border-neutral-700">
                <h3 id="transaction-add-modal-label" class="font-bold text-gray-800 dark:text-white">
                    Tambah Transaksi
                </h3>
                <button type="button"
                    class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600"
                    aria-label="Close" data-hs-overlay="#transaction-add-modal">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <form action="" class="space-y-4 mb-4 relative" wire:submit="storeTransaction">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-[100]">
                        ...
                        <div class="">
                            <div class="relative">
                                <input wire:model='amount' type="text" id="hs-inline-leading-pricing-select-label"
                                    name="inline-add-on"
                                    class="py-2.5 sm:py-3 px-4 ps-10 pe-20 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:border-teal-600 dark:focus:ring-teal-600"
                                    placeholder="0.00">
                    ...
                    <div class="relative z-[100]">
                        <textarea id="textarea-description" wire:model='description'
                            class="py-2 px-3 sm:py-3 sm:px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:border-teal-600 dark:focus:ring-teal-600"
