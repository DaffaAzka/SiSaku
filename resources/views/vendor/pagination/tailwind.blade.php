@if ($paginator->hasPages())
    <nav class="flex justify-between items-center gap-x-1" aria-label="Pagination">
        ...
        <div class="flex items-center gap-x-1">
            ...
            <span
                class="min-h-9.5 flex justify-center items-center text-gray-500 py-2 px-1.5 text-sm">of</span>
            <span
                class="min-h-9.5 flex justify-center items-center text-gray-500 py-2 px-1.5 text-sm">
                {{ $paginator->lastPage() }}
            </span>
        </div>
